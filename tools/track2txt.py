...
def make_parser():
    parser = argparse.ArgumentParser("Track To Txt")
    ...
    parser.add_argument(
        "--savePath", default="../videos/FirstRestaurant/idInfo", help="path to images or video"
    )
...
def write_results(filename, results):
    save_format = '{frame},{id},{cx},{maxY},{w},{h},{s},\n'
...
def imageflow_demo(predictor, vis_folder, args):
    ...
    while True:
        if frame_id % 20000 == 0:
            ...
            res_file = osp.join(vis_folder, f"{fileName}.txt")
            ...
            if outputs[0] is not None:
                ...
                for t in online_targets:
                    ...
                    if tlwh[2] * tlwh[3] > args.min_box_area and not vertical:
                        ...
                        results.append(
                            f"{frame_id},{tid},{cx:.2f},{cy:.2f},{tlwh[2]:.2f},{tlwh[3]:.2f},{t.score:.2f}\n"
                        )
                timer.toc()
            else:
                timer.toc()
